          ...
          <div className="w-full max-w-sm">
            ...
            <div className="relative my-4">
              ...
              <div className="relative flex justify-center text-[10px]">
                <span className="px-2 bg-[#6F4E37] text-gray-400">Or</span>
              </div>
            </div>

            <button className="w-full flex items-center justify-center gap-2 text-xs text-gray-300 hover:text-white transition-colors">
              <span>Sign in with google</span>
              {/* Simple Google G icon placeholder could go here if needed */}
            </button>
